function loadInfinitePost()	
{
	if(jQuery('#infinite_loading_status').val() == 0)
	{
		...
		jQuery.ajax({
	        ...
	        type:'POST',
	        data: 'action=grandblog_post&current_query=a:1:{s:14:"posts_per_page";s:1:"6";}&items=12&items_ini=6&offset='+currentOffset+'&columns=3&tg_security='+tgAjax.ajax_nonce, 
